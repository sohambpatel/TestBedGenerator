...
public class GenAIHandler {
    ...
    //This is the java coded ChatGPT completion api which further reports if the chat gpt is not returning 200
    public String generateResults(String prompt) throws Exception {
        String id = "";
